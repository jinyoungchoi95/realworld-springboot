...
class ArticleFavoriteTest {
    ...
    @Test
    void articleFavoriteTest() {
        ArticleFavorite articleFavorite = new ArticleFavorite();
    }

    @Test
    @DisplayName("equals hashCode 테스트")
    void articleFavoriteEqualsHashCodeTest() {

        // when
        ArticleFavorite result = ArticleFavorite.from(user, article);

        // then
        assertThat(result)
            .isEqualTo(ArticleFavorite.from(user, article))
            .hasSameHashCodeAs(ArticleFavorite.from(user, article));
